# Chapter08-Day02 · RAG 전처리 고도화

Chapter08-Day02는 [Chapter07-Day04의 Django 개인화 RAG 챗봇](../Chapter07-Day04/02_Django_Personalized_RAG_Web_Chatbot)을 기반으로 문서 전처리와 검색 품질을 개선한 버전입니다. 채팅 UI와 사용자별 데이터 격리는 유지하면서, PDF/OCR 문서를 더 안정적으로 구조화하고 LangGraph 기반 파이프라인으로 Milvus 색인 과정을 확장했습니다.

## Chapter07-Day04와 달라진 점

| 구분 | Chapter07-Day04 | Chapter08-Day02 |
| --- | --- | --- |
